...
public abstract class Paddle : MonoBehaviour
{
    ...
    [Tooltip("Topun raketin neresine çarptýðýna baðlý olarak raketten nasýl sekeceðini deðiþtirir. " +
        "Raketin merkezinden ne kadar uzaksa sýçrama açýsý da o kadar dik olur.")]
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (useDynamicBounce && collision.gameObject.CompareTag("Ball"))
        {
            ...
            // Çarpýþma hakkýnda bilgi toplama
            ...
            // Oyunu daha dinamik ve ilginç hale getirmek için
            // Temas mesafesine göre topun yönünü döndür
